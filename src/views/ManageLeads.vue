...
export default {
    ...
    methods:{
        ...
        getLeads(){
          ...
          var staff = localStorage.getItem("user_stafftype")
            if(staff === "IT"){
               ...
               this.agents = []
          this.show = true;
          axios.get('https://us-central1-homesforexpats.cloudfunctions.net/getClients').then( res => {
        ...
        deleteAccount(){
          ...
          this.show = true
          //Delete Account
            axios.post('https://us-central1-homesforexpats.cloudfunctions.net/deleteClient',this.updateAgent).then( res => {

                        console.log(res.data.title);
                        
                        this.show = false
                        if (res.data.title === 'success'){
                            this.$bvToast.toast('Client Succesfully Deleted!', {
