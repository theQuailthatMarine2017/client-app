            ...
            <b-list-group-item> <span style="font-weight:bold;"><h5>Manage</h5></span>
                ...
                <b-list-group flush>
                    <b-list-group-item>
                        ...
                        <b-button @click="goSideBar('manage-holiday')" style="background-color:#0386ac;font-weight:bold;" block>Holiday Deal</b-button>                        </b-list-group-item>
                </b-list-group>
            </b-list-group-item>
            </b-list-group>
...
export default {
    ...
    methods:{
        ...
        deleteAccount(){
          ...
          this.show = true
          //Delete Account
            axios.post('https://us-central1-homesforexpats.cloudfunctions.net/deleteHoliday',this.updateAgent).then( res => {
                        ...
                        if (res.data.title === 'success'){
                            this.$bvToast.toast('Holiday Succesfully Deleted!', {
